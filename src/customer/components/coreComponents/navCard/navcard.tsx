        ...
        <div className="navcard-wrapper">
            <div className="navcard-item-container-wrapper">
                <ul className="navcard-items-list">
                   <Link to='/grocery' style={{textDecoration:'none', color:'inherit'}}><li className='navcard-menu-text'>Grocery</li></Link>
                   <Link to='/mobile' style={{textDecoration:'none', color:'inherit'}}><li className='navcard-menu-text'>Mobile</li></Link>
                    ...
                    <Link to='' style={{textDecoration:'none',color:'inherit'}}><li className='navcard-menu-text'>Appliances</li></Link>
                    <Link to='' style={{textDecoration:'none',color:'inherit'}}><li className='navcard-menu-text'>Travel</li></Link>
